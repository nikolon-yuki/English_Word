...
#         lis = line.split('\t')
#         input_text, target_text = lis[0],lis[1]
...
#     sentence, max_encoder_seq_length, num_encoder_tokens, input_token_index
# ):
...
#     # 英語辞書データの生成
#     input_token_index = dict([(char, i) for i, char in enumerate(i_chars)])
#     # 日本語辞書データの生成
#     target_token_index = dict([(char, i) for i, char in enumerate(t_chars)])
