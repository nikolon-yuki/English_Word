...
# ) = get_num_word(input_characters, target_characters, input_texts, target_texts)
# # 英語,日本語辞書データの生成
...
#             form = forms.UserForm()
#             vec = sentence_to_vector(
#                 input_seq, max_encoder_seq_length, num_encoder_tokens, input_token_index
#             )
#             rets = decode_sequence(
#                 vec,
#                 num_decoder_tokens,
#                 target_token_index,
#                 encoder_model,
...
#             c = {"form": form, "rets": rets, "talktxts": talktxts}
